...
// Adapted from etxt/examples/ebiten/bbcode
...
func main() {
	// create custom vertical sizer for a slightly more comfy line height
	var vertSizer sizer.CustomVertSizer
	vertSizer.AscentMult  = fract.FromFloat64(0.94)
	vertSizer.DescentMult = fract.FromFloat64(0.40)
	...
	err := ebiten.RunGame(&Game{ text: &bbcodeRenderer, defaultSizer: defaultSizer })
